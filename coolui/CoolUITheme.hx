 ...
 *
 * Example of integration into the engine:
 *
...
class CoolUITheme {
	...
	public static function applyDark():Void
		set(_defaultDark());

	public static function applyNeon():Void
		set(_neon());

	public static function applyLight():Void
		set(_light());
	...
	static function _int(t:Dynamic, field:String, fallback:Int):Int {
		try {
			...
			if (Std.isOfType(v, Float))
				return Std.int(cast v);
		} catch (_:Dynamic) {}
		return fallback;
	}

	static function _defaultDark():CoolTheme
		return {
			bgDark: 0xFF0B0B16,
			bgPanel: 0xFF13131F,
	...
	static function _neon():CoolTheme
		return {
			bgDark: 0xFF060612,
			bgPanel: 0xFF0E0E22,
	...
	static function _light():CoolTheme
		return {
			bgDark: 0xFFD8D8E8,
			bgPanel: 0xFFEAEAF4,
