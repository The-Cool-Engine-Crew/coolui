...
class CoolButton extends FlxSpriteGroup {
	 ...
	 */
	public function new(px:Float = 0, py:Float = 0, label:String = "", ?onClick:Void->Void, width:Int = DEFAULT_W, height:Int = DEFAULT_H,
	...
	override public function update(elapsed:Float):Void {
		...
		if (inBtn != _hover) {
			...
			if (_tween != null)
				_tween.cancel();
			_tween = FlxTween.globalManager.tween(_bg, {alpha: _hover ? 1.3 : 1.0}, 0.08, {ease: FlxEase.quartOut});
		}
